...
/** Labelled toggle. The button is a 44px hit area; the visible track is 44×24. */
  ...
  return (
    <div className="flex items-start justify-between gap-6 border-b border-line py-4 last:border-b-0">
      ...
      <button
        ...
        className="-mr-2 flex h-11 w-14 shrink-0 cursor-pointer items-center justify-center rounded-md"
      >
        <span
          aria-hidden="true"
          className={`relative h-6 w-11 rounded-full transition-colors duration-200 ${checked ? "bg-brand" : "bg-line"}`}
        >
          <span
